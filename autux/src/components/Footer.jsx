...
function Footer() {
  return (
    <>
      <footer className="footer_component max-width-full">
            ...
            <div className="padding-vertical padding-xxlarge">
              <div className="padding-bottom padding-xxlarge">
                <div className="w-layout-grid footer4_top-wrapper">
                  <a
                    href="#"
                    id="w-node-fe378366-a99c-0124-da18-3efe483f27be-53302248"
                  ...
                  <div className="w-layout-grid footer4_link-list">
                    <a href="#services-usp" className="footer4_link">
                      Services
                    </a>
                    <a href="#sectiion-benefits" className="footer4_link">
                      Benefits
                    </a>
                    <a href="#process" className="footer4_link">
                      Process
                    </a>
                    <a href="#testimonials" className="footer4_link">
                      Testimonials
                    </a>
                  </div>
                  <div
                    id="w-node-fe378366-a99c-0124-da18-3efe483f27cb-53302248"
                    className="w-layout-grid footer4_social-list"
                  >
                    <a href="#" className="footer4_social-link hide w-inline-block">
              ...
              <div className="padding-top padding-medium">
                <div className="w-layout-grid footer4_bottom-wrapper">
                  <div
                    id="w-node-fe378366-a99c-0124-da18-3efe483f27d9-53302248"
                    className="footer4_credit-text"
                  >
                    © 2025 AutuX. All rights reserved.
                  </div>
                  <a href="#" className="footer4_legal-link hide">
                    Privacy Policy
                  </a>
                  <a href="#" className="footer4_legal-link hide">
                    Terms of Service
                  ...
                  <div className="div-block-19">
                    <div className="credit">
                      ...
                      <img
                        loading="lazy"
                        src="https://cdn.prod.website-files.com/67416bf9ad9706da53302213/675a7700b29c1466a43948a1_red%20heart.svg"
                        alt=""
                      />
                      <div>
                        by{" "}
